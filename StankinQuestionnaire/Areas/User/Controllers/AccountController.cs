...
namespace StankinQuestionnaire.Areas.User.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        //private UserManager<ApplicationUser> гserManager;

        public AccountController(IUserService userService, UserManager<ApplicationUser,long> userManager)
        {
        ...
        public ActionResult LogOff()
        {
            ...
            return Redirect("~/"); //RedirectToAction("Index", "Documents");
        }
